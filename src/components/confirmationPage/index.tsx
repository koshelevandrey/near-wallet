...
const ConfirmationPage = () => {
    ...
    <div className='body'>
     ...
     <div className='recipientContainer'>
        ...
        <div className='value'>df4d127066e5716ebf9970cecb0bb444d<br/>e72a5ccbbaca40562bbeb4a68472920</div>
     </div>
   ...
   <div style={{height : '16px', marginBottom : '12px'}} >
      ...
      <div className='value'>
        <div className='valueTitle'><Icon src={iconsObj.nearMenu}/>NEAR</div>
      </div>
   </div>
    <div>
      <div className='title'>Estimated fees</div>
        <div className='value'>
          <div className='valueTitle'><Icon src={iconsObj.nearMenu}/>0.00005 NEAR</div>
     ...
     <div>
         <div className='title'>Estimated total</div>
          <div className='value'>
            <div className='valueTitle'><Icon src={iconsObj.nearMenu}/>0.00105 NEAR</div>
            <div className='valueSecondaryTitle'>{`${'< $0.01 USD'}`}</div>
          </div>
     </div>
     </div>
