...
const ChooseMethod = () => {
 return <div className='chooseMethodContainer'>
    <Header/>
    <div className='body'>
     <div className='title'>Choose a Security Method</div>
     <div className='text'>Select a method to secure and recover your
        account. This will be used to verify important activity, 
        recover your account and access your account from other devices
     </div>
     <div className='btnContainer'>
        <button onClick={() => {goTo(BalancePage)}}  type='button'  className='btnChoose'>
